            ...
            <div class="w-full md:w-5/12 ml-auto mr-auto px-4">
              <div class="md:pr-12">
                ...
                <p class="mt-4 text-lg leading-relaxed text-gray-600">
                  Our team has worked on hundreds of projects lifting and repairing concrete and asphalt in many
              ...
              <div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-gray-300">
                <form name="PrideForm" id="myForm" method="post" data-netlify="true" enctype="application/x-www-form-urlencoded" @submit.prevent="checkForm" class="flex-auto p-5 lg:p-10">
                  ...
                  <div class="relative w-full mb-3 mt-8">
                    ...
                    <input type="text" name="name" v-model="formData.name" class="px-3 py-3 placeholder-gray-400 text-gray-700 bg-white rounded text-sm shadow focus:outline-none focus:shadow-outline w-full" placeholder="Full Name" style="transition: all 0.15s ease 0s;" />
                  </div>
                  <div class="relative w-full mb-3">
                    <label class="block uppercase text-gray-700 text-xs font-bold mb-2" for="email">
                      Telephone
                    </label>
                    <input type="tel" name="telephone" v-model="formData.telephone" class="px-3 py-3 placeholder-gray-400 text-gray-700 bg-white rounded text-sm shadow focus:outline-none focus:shadow-outline w-full" placeholder="Email" style="transition: all 0.15s ease 0s;" />
                  </div>
                  <div class="relative w-full mb-3">
                    <label class="block uppercase text-gray-700 text-xs font-bold mb-2" for="email">
